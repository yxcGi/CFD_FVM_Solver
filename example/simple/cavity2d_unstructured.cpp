...
int main()
{
    ...
    // U.setBoundaryCondition("movingWall", 1, 0, Vector<Scalar>(20, 0, 0));    // Re = 2000
    U.setBoundaryCondition("movingWall", 1, 0, Vector<Scalar>(50, 0, 0));    // Re = 5000
    ...
    U.writeToFile("U_cavity2d_unstructured.dat");
    p.writeToFile("p_cavity2d_unstructured.dat");
